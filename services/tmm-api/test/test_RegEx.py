...
class TestRegEx(unittest.TestCase):
    ...
    def test_extract_numbers_temperature(self):
        self.assertEqual(
            PayloadParser.extract_numbers_from_string("19.9 °C")[0], "19.9"
        )
    ...
    def test_extract_numbers_voltage(self):
        self.assertEqual(
            PayloadParser.extract_numbers_from_string("3.6534 V")[0], "3.6534"
        )
    ...
    def test_extract_units_conductivity(self):
        self.assertEqual(
            PayloadParser.extract_units_from_string("55 uS/cm")[0], "uS/cm"
        )
